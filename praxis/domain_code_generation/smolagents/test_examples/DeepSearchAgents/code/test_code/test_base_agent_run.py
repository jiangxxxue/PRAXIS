...
from agents.base_agent import BaseAgent, MultiModelRouter  # [agents.base_agent.BaseAgent.run()](PRAXIS/praxis/domain_code_generation/smolagents/test_examples/DeepSearchAgents/code/src/agents/base_agent.py:313)
from agents.run_result import RunResult  # [agents.run_result.RunResult](PRAXIS/praxis/domain_code_generation/smolagents/test_examples/DeepSearchAgents/code/src/agents/run_result.py:1)
