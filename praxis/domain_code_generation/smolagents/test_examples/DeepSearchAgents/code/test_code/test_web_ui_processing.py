...
process_planning_step = _web.process_planning_step  # [api.v2.web_ui.process_planning_step()](PRAXIS/praxis/domain_code_generation/smolagents/test_examples/DeepSearchAgents/code/src/api/v2/web_ui.py:186)
process_action_step = _web.process_action_step  # [api.v2.web_ui.process_action_step()](PRAXIS/praxis/domain_code_generation/smolagents/test_examples/DeepSearchAgents/code/src/api/v2/web_ui.py:395)
process_final_answer_step = _web.process_final_answer_step  # [api.v2.web_ui.process_final_answer_step()](PRAXIS/praxis/domain_code_generation/smolagents/test_examples/DeepSearchAgents/code/src/api/v2/web_ui.py:743)
DSAgentRunMessage = _models.DSAgentRunMessage  # [api.v2.models.DSAgentRunMessage](PRAXIS/praxis/domain_code_generation/smolagents/test_examples/DeepSearchAgents/code/src/api/v2/models.py:1)
