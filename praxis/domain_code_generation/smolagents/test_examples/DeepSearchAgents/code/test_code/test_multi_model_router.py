...
# Path: PRAXIS/praxis/domain_code_generation/smolagents/knowledge_corpus/smolagents/src
...
from agents.base_agent import MultiModelRouter  # [agents.base_agent.MultiModelRouter](PRAXIS/praxis/domain_code_generation/smolagents/test_examples/DeepSearchAgents/code/src/agents/base_agent.py:39)

# Provide fallback stubs if smolagents.models is unavailable in environment
try:
    from smolagents.models import ChatMessage, ChatMessageStreamDelta  # [smolagents.models.ChatMessage](PRAXIS/praxis/domain_code_generation/smolagents/knowledge_corpus/smolagents/src/smolagents/models.py:1)
except Exception:
    class ChatMessage:
