...
def _ensure_smolagents_on_path():
    ...
    # Priority: PRAXIS/praxis/domain_code_generation/smolagents/knowledge_corpus/smolagents
    added_kc = False
    for up in range(2, 12):
        # kc_parent = test_file.parents[up] / "PRAXIS/praxis/domain_code_generation" / "smolagents" / "knowledge_corpus"
