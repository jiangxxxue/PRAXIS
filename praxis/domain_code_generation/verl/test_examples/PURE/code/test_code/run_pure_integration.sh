...
TRAIN_FILES=/PRAXIS/praxis/domain_code_generaiton/verl/test_examples/PURE/code/train.parquet
VAL_FILES=/PRAXIS/praxis/domain_code_generaiton/verl/test_examples/PURE/code/val.parquet
...
cd /PRAXIS/praxis/domain_code_generaiton/verl/test_examples/PURE/code
